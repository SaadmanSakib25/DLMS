...
class Book(models.Model):
    ...
    call_number = models.CharField(max_length=30, default='Contact the librarian')
    author_1 = models.CharField(max_length=80, default='', null=False)
    author_2 = models.CharField(max_length=80, blank = True, default='', null=True)
    author_3 = models.CharField(max_length=80, blank = True, default='', null=True)
    #########################################
    # author = models.ManyToManyField(Author, help_text="Select an author for this book")
    ########################################
    isbn = models.CharField('ISBN', max_length=13,
                            help_text='<a href="https://www.isbn-international.org/content/what-isbn" style="color:#00067A; ">ISBN number</a>')
